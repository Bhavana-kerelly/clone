...
export default function Podcasts() {
  ...
  useEffect(() => {
    document.title = "KVS Infra Leadership & Insights";
    window.scrollTo(0, 0);
  ...
  return (
    <div ref={containerRef} className="bg-dark-blue min-h-screen pt-36 pb-32 text-white overflow-hidden selection:bg-[#c4a468] selection:text-white">
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-28 flex flex-col items-center">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-extralight tracking-tight text-dark-blue leading-none mb-6">
            KVS Infra <span className="font-serif italic font-normal text-[#c4a468]">Insights</span>
          </h1>
          ...
          <p className="text-sm sm:text-base text-dark-blue/70 max-w-2xl font-light leading-relaxed">
            Read and listen to the ideas shaping our approach to land, planning, and long-term value creation across emerging development corridors.
          </p>
        </div>
              ...
              <div className="flex-grow flex flex-col justify-between text-left h-full w-full py-1">
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-dark-blue/60 leading-relaxed font-light mb-6 text-justify lg:max-w-3xl">
                    {podcast.description || 'Explore the planning, execution, and land-value strategy behind KVS Infra’s growth corridors and plotted developments.'}
                  </p>
                </div>
