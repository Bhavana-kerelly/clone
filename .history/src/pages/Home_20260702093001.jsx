      ...
      <section className="py-36 px-4 sm:px-6 lg:px-12 max-w-[1440px] mx-auto relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
          {featuredProperties.map((property, index) => (
            ...
            >
              {/* Premium Floating Base Effect */}
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/80 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-500 z-10 pointer-events-none"></div>
              <PropertyCard property={property} />
              
              {/* Apple Micro-border Shimmer wrapper */}
              <div className="absolute inset-0 rounded-3xl border border-white/0 group-hover:border-white/10 transition-all duration-500 pointer-events-none z-20"></div>
            </div>
          ))}
        </div>
