  ...
  <div className="flex flex-col md:flex-row md:items-end justify-between mb-28 border-b border-white/[0.05] pb-16 relative group/header">
    <div className="max-w-2xl text-left">
      ...
      <h2 className="text-5xl md:text-7xl font-extralight tracking-tight text-white mb-0 leading-tight">
        Luxury Lives <span className="font-serif italic font-normal text-transparent bg-clip-text bg-gradient-to-r from-sage via-white to-sage bg-[length:200%_auto] animate-[shimmer-text_8s_linear_infinite] font-cursive">Here</span>
      </h2>
    </div>
        ...
        <div className="absolute inset-x-8 bottom-8 z-20 text-left flex flex-col justify-end pointer-events-auto">
          ...
          <div className="flex items-center justify-between border-t border-white/[0.08] pt-5 mt-2 relative">
            ...
            <div className="transform transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1">
              <span className="block text-[8px] uppercase font-bold tracking-[0.3em] text-white/30 mb-1">Investment Base</span>
