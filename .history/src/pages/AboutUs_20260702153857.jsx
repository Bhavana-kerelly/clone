      ...
      <section ref={profileSectionRef} className="max-w-7xl mx-auto px-6 md:px-12 py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-20">
        ...
        <div ref={profileTextRef} className="flex flex-col gap-6 text-left will-change-transform">
          ...
          <h2 className="font-display text-4xl font-light text-dark-blue tracking-tight leading-none">
            About <span className="font-serif italic font-normal text-[#c4a468]">Our Vision</span>
          </h2>
          ...
          <p className="text-sm sm:text-base text-dark-blue/80 leading-relaxed font-light text-justify">
            KVS Infra is built around disciplined land acquisition, layout design, and plotted community development. Our team combines local market insight with strong execution to turn raw land into structured, high-value opportunities for families and investors.
          </p>
          <p className="text-sm sm:text-base text-dark-blue/80 leading-relaxed font-light text-justify">
            Our operating philosophy is simple: transparency, clear documentation, quality infrastructure, and long-term value creation. Every project is shaped with the same emphasis on accountability, execution, and customer confidence.
          </p>
