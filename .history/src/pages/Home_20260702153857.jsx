      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-12 pt-28 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center flex flex-col items-center">
          ...
          >
            ...
            >
              <span className="block text-[9px] uppercase font-bold tracking-widest text-white/40 mb-1.5">Location</span>
              <div className="relative">
                ...
                >
                  ...
                  <option value="Tirupati" className="bg-[#0F121D]">Tirupati</option>
                  <option value="Chandragiri" className="bg-[#0F121D]">Chandragiri</option>
                  <option value="Noida" className="bg-[#0F121D]">Noida, Delhi NCR</option>
                  <option value="Gurugram" className="bg-[#0F121D]">Gurugram, Delhi NCR</option>
                </select>
            ...
            >
              <span className="block text-[9px] uppercase font-bold tracking-widest text-white/40 mb-1.5">Configuration</span>
              <div className="relative">
                <select 
                  value={searchBeds} 
            ...
            >
              <span className="block text-[9px] uppercase font-bold tracking-widest text-white/40 mb-1.5">Budget</span>
              <div className="relative">
                <select 
                  value={searchPrice} 
                ...
                >
                  ...
                  <option value="5000000" className="bg-[#0F121D]">Under ₹50 Lakh</option>
                  <option value="10000000" className="bg-[#0F121D]">Under ₹1 Crore</option>
                  <option value="20000000" className="bg-[#0F121D]">Under ₹2 Crore</option>
                </select>
                <ChevronRight className="w-3.5 h-3.5 absolute right-0 top-1/2 -translate-y-1/2 rotate-90 text-white/30 pointer-events-none" />
              </div>
            </div>
...
<section className="py-40 px-4 sm:px-6 lg:px-12 max-w-[1440px] mx-auto relative z-20 overflow-hidden">
  
  {/* Header: Cinematic Reveal with Text Mask Tracking */}
  <div className="flex flex-col md:flex-row md:items-end justify-between mb-28 border-b border-white/[0.05] pb-16 relative group/header">
    <div className="max-w-2xl text-left">
      ...
      <h2 className="text-5xl md:text-7xl font-extralight tracking-tight text-white mb-0 leading-tight">
    ...
    <p className="text-sm md:text-base text-white/40 max-w-md font-light leading-relaxed mt-8 md:mt-0 md:pl-8 border-l-0 md:border-l border-white/10 transition-colors duration-500 group-hover/header:text-white/60">
  ...
  {/* View All Master Button Area */}
  <div className="flex justify-center mt-32 relative z-30">
    <Link 
      to="/search-result-sales" 
      className="group relative inline-flex items-center gap-4 px-12 py-6 bg-white/[0.01] hover:bg-white text-white hover:text-[#07090E] border border-white/10 rounded-full font-medium tracking-[0.15em] text-[11px] uppercase transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-2xl overflow-hidden cursor-pointer"
    >
      <span className="relative z-10">Explore All Listings</span>
      <ArrowRight className="w-4 h-4 relative z-10 group-hover:translate-x-2 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]" />
      {/* Background fill wave effect */}
      <div className="absolute inset-0 bg-white scale-x-0 origin-right group-hover:scale-x-100 group-hover:origin-left transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] z-0 mix-blend-difference"></div>
    </Link>
  </div>
